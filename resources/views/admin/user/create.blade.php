            ...
            <div class="w-full bg-white rounded-md p-5">
                ...
                <div class="w-full mt-5">
                    ...
                    <form action="{{ route('users.store') }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-5 pb-5">
                        ...
                        {{-- NAMA RAPAT --}}
                        <div class="relative z-0 w-full mt-5">
                            <select value="{{ old('role') }}" name="role" id="role" class="@error('role') border-red-500 @enderror border-gray-300 block py-2.5 px-3 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer">
