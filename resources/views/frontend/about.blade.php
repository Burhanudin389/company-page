...
@section('content')
    ...
    <header class="relative w-full h-96">
        ...
        <div class="absolute pt-10 inset-0 z-10 w-full h-full">
            <div class="max-w-screen-custom h-full px-4 mx-auto flex flex-col justify-center items-center">
                ...
                <p data-aos="fade-up" data-aos-delay="300" class="max-w-md mt-5 text-zinc-500 mx-auto text-center">Konsultanku adalah platform bisnis terpercaya</p>
            </div>
        </div>
    </header>
    {{-- END : HEADER --}}
    ...
    <div class="w-full pt-20 pb-10 md:pt-0">
        <div data-aos="fade-up" data-aos-delay="100" class="w-full max-w-screen-custom mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-5 items-center">
