            ...
            <div class="w-full bg-white rounded-md p-5">
                ...
                <div class="w-full mt-5">
                    ...
                    <form action="{{ route('users.update', $user->id) }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-5 pb-5">
                        ...
                        {{-- ROLE PENGGUNA --}}
                        <div class="relative z-0 w-full mt-5">
                            <select value="{{ old('role') }}" name="role" id="role" class="@error('role') border-red-500 @enderror border-gray-300 block py-2.5 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-purple-600 peer">
