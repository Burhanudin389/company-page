                    ...
                    <form action="{{ route('privillege.update', $privillege->id) }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 gap-5 pb-5">
                        ...
                        <div class="relative z-0 w-full grid grid-cols-1 md:grid-cols-2 gap-5 mt-5">
                            <div class="w-full flex space-x-5 items-center bg-slate-100 p-5 rounded-md">
                                ...
                                <img src="{{ asset('storage/uploads/privillege/'. $privillege->icon) }}" class="w-28 block" alt="" />
                            </div>
                            <div class="w-full">
